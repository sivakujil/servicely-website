        ...
        <section className="contact-section">
          <div className="contact-container">
            ...
            <div className="contact-info">
              ...
              {/* ================= EMAIL ================= */}
              <a
                href="mailto:info@northernsustain.com"
              ...
              >
                ...
                <div>
                  <span>Email Us</span>
                  <strong>info@northernsustain.com</strong>
                </div>
              </a>

              {/* ================= PHONE ================= */}
              <a
                href="tel:+94212228350"
                className="contact-info-card"
              >
                <div className="contact-icon">
                  <Phone size={21} />
              ...
              <div className="contact-info-card">
                ...
                <div>
                  ...
                  <strong>
                    No-106/1, Ramanathan Road,
                    <br />
                    Thirunalveely, Jaffna
                  </strong>
                </div>
              </div>
              ...
              <div className="contact-social-section">
                ...
                <div className="contact-socials">
                  ...
                  {/* LinkedIn */}
                  <a
                    href="https://www.linkedin.com/company/northern-engineering-consortium-pvt-ltd/home/"
                  ...
                  {/* Facebook */}
                  <a
                    href="https://web.facebook.com/people/Nec-Nec/pfbid02ogcEH4LHLbCYSP2MBXq9FZKWBqtzyh1CfjWuhvUGGk9bkoykV72SvJyfVXykdKDkl/"
            ...
            {/* ===== IMPORTANT: contact-info closed here ===== */}
